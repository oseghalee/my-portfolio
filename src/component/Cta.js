...
const Cta = () => {
  return (
    <div className='px-6 pt-8' id='Cta'>
      <div className='container mx-auto flex justify-center items-center pb-[5rem] md:pt-4 md:p-[5rem] w-full '>
        <div className='items-center rounded-lg shadow-xl shadow-white p-4 py-7 md:p-8 md:px-16 md:flex md:gap-10 md:justify-start'>
          <div className=''>
          ...
          <div>
            <h1 className='text-xl pt-2 md:text-2xl font-bold text-center leading-6 tracking-wider text-black '>Contact</h1>
